...
#SBATCH --job-name=eds_nwc_uracil2_6-31gs_000384
#SBATCH --error=eds_nwc_uracil2_6-31gs_000384.e%j
#SBATCH --output=eds_nwc_uracil2_6-31gs_000384.o%j
...
#
mkdir $SCRATCH_DIR
cp uracil2_ccsd_t.nw                    $SCRATCH_DIR
cp $NWCHEM_EXECUTABLE                   $SCRATCH_DIR
cd $SCRATCH_DIR
#
# Fire up NWChemEx
#
srun -n $SLURM_NPROCS ./nwchem uracil2_ccsd_t.nw
#
# Clean up
#
rm -rf $SCRATCH_DIR
