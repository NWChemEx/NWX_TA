...
#SBATCH --job-name=cori_nwx_dgrtl_sto-3g_000256
#SBATCH --error=cori_nwx_dgrtl_sto-3g_000256.e%j
#SBATCH --output=cori_nwx_dgrtl_sto-3g_000256.o%j
...
#
mkdir $SCRATCH_DIR
cp ../input/dgrtl.xyz                   $SCRATCH_DIR
