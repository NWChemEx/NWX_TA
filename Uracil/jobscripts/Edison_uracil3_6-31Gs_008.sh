...
#SBATCH --job-name=eds_nwc_uracil3_6-31gs_000192
#SBATCH --error=eds_nwc_uracil3_6-31gs_000192.e%j
#SBATCH --output=eds_nwc_uracil3_6-31gs_000192.o%j
...
#
mkdir $SCRATCH_DIR
cp uracil3_ccsd_t.nw                    $SCRATCH_DIR
cp $NWCHEM_EXECUTABLE                   $SCRATCH_DIR
cd $SCRATCH_DIR
#
# Fire up NWChemEx
#
srun -n $SLURM_NPROCS ./nwchem uracil3_ccsd_t.nw
#
# Clean up
#
rm -rf $SCRATCH_DIR
